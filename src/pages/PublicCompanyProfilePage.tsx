                    ...
                    <div className="bg-white rounded-2xl shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            {opportunities.map((position) => (
                                <div key={position.id} className="border border-gray-200 rounded-xl p-6 hover:shadow-md transition-shadow">
                                    ...
                                    <button className="px-6 py-2 bg-[#003B80] text-white rounded-full hover:bg-[#002A5C] transition-colors font-medium">
                                        Ver detalles
                                    </button>
                                </div>
                            ))}
