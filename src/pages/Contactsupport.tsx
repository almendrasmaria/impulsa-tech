...
export default function Contactsupport() {
  ...
  return (
    <main className="py-[clamp(1.5rem,4vw,3rem)] m-0 font-[Poppins] bg-[#f7faff] page-support">
        ...
        <div className="bg-white border border-[#D9D9D9] rounded-[20px] shadow-[0_6px_24px_rgba(16,24,40,0.06)] p-[clamp(16px,2.5vw,28px)]">
          <div className="grid grid-cols-[1.05fr_0.95fr] gap-[clamp(16px,3vw,32px)] items-center">
            <div className="form-col">
              ...
              >
                <div className="grid gap-2">
                  <label htmlFor="name" className="text-[rgba(0,0,0,0.72)] text-base tracking-[0.32px]">Nombre</label>
                  <input
                    id="name"
                ...
                <div className="grid gap-2">
                  <label htmlFor="email" className="text-[rgba(0,0,0,0.72)] text-base tracking-[0.32px]">Correo electrónico</label>
                  <input
                    className="w-full h-12 border border-[#D9D9D9] rounded-lg px-3.5 outline-none bg-white placeholder:text-[#9BA0A6] focus:border-[#B9C0FF] focus:shadow-[0_0_0_3px_rgba(24,41,219,0.12)]"
                    id="email"
                    type="email"
                ...
                <div className="grid gap-2">
                  <label htmlFor="subject" className="text-[rgba(0,0,0,0.72)] text-base tracking-[0.32px]">Asunto</label>
                  <input
                    className="w-full h-12 border border-[#D9D9D9] rounded-lg px-3.5 outline-none bg-white placeholder:text-[#9BA0A6] focus:border-[#B9C0FF] focus:shadow-[0_0_0_3px_rgba(24,41,219,0.12)]"
                    id="subject"
                    type="text"
                ...
                <div className="grid gap-2">
                  <label htmlFor="message" className="text-[rgba(0,0,0,0.72)] text-base tracking-[0.32px]">Mensaje</label>
                  <textarea
            ...
            <div className="grid place-items-center max-[980px]:order-first">
              ...
              <img
                src="https://images.unsplash.com/photo-1423666639041-f56000c27a9a?w=474&q=80"
                alt="support hero"
                loading="lazy"
